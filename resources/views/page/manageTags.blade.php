...
@section('content')
<h1 class="text-center text-3xl p-10">Créer un nouveau Tag</h1>
...
<main class="flex flex-row justify-center">
    <form class="[min-width:400px] w-1/2" action="" method="post">
        ...
        <button class="mx-auto block mt-4 border rounded-sm bg-amber-300 pl-4 pr-4 pt-1 pb-1">Nouveau Tag</button>
